...
/**
 * 分页类
 * @author wangyingnan wanngyingnan@hylink.net.cn
 * 创建时间：2017年8月15日
 */
public class Page implements Serializable {
	...
	private static final long serialVersionUID = -6722670696296742034L;
	@ApiModelProperty(value = "showCount",example = "10")
	private int showCount; //每页显示记录数
	private int totalPage;		//总页数
	private int totalResult;	//总记录数
	@ApiModelProperty(value = "currentPage",example = "1")
